...
const steps = [
  ...
  },
  {
    ...
    detail: "A real clinician makes a clinical determination independently. Sleepgenic provides the access layer — your provider owns the decision.",
  },
  {
...
export default function HowItWorksPage() {
  return (
    <main style={{ background: S.bg, minHeight: "100vh", paddingTop: 64 }}>
      <section className="hiw-hero section-pad" style={{ padding: "5rem 2rem 4rem", borderBottom: `1px solid ${S.border}` }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          ...
          <p style={{ fontFamily: S.syne, fontSize: "1rem", color: S.text2, maxWidth: 680, lineHeight: 1.65 }}>
            Four steps. No referrals, no year-long queue, no ambiguous next step. Licensed provider review in 24 hours.
          </p>
        </div>
      </section>

      <section className="hiw-steps section-pad" style={{ padding: "4rem 2rem", background: S.bg2, borderBottom: `1px solid ${S.border}` }}>
      ...
      <section className="hiw-bottom section-pad" style={{ padding: "4rem 2rem 5rem" }}>
        <div className="hiw-bottom-grid grid-2col" style={{ maxWidth: 1100, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "2rem" }}>
          <div style={{ background: S.surface, border: `1px solid ${S.border}`, padding: "2rem" }}>
            ...
            <p style={{ fontFamily: S.syne, color: S.text2, lineHeight: 1.65, fontSize: "0.95rem" }}>
              CBT-I is first-line for chronic insomnia per AASM guidance. Your provider assigns a CBT-I protocol where clinically appropriate and may prescribe medication where indicated. Sleepgenic does not deliver therapy — your provider does.
            </p>
          </div>
          <div style={{ background: S.surface, border: `1px solid ${S.border}`, padding: "2rem" }}>
            ...
            <p style={{ fontFamily: S.syne, color: S.text2, lineHeight: 1.65, fontSize: "0.95rem", marginBottom: "1rem" }}>
              Cash-pay sleep medicine access. Licensed provider review within 24 hours. $149/month.
            </p>
