    ...
    <main style={{ background: S.bg, minHeight: "100vh" }}>
      ...
      <section className="home-hero" style={{
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto", width: "100%", position: "relative", zIndex: 1 }}>
          <div style={{ maxWidth: 760 }}>
            ...
            <div className="home-hero-stats hero-stats" style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "2rem", maxWidth: 560 }}>
              {[
        ...
        <div className="home-floating-panel hero-data-panel" style={{
      ...
      <section className="home-problem-solution" style={{
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <div className="home-problem-grid grid-2col" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "6rem", alignItems: "start" }}>
            <div>
      ...
      <section className="home-credibility" style={{ padding: "5rem 2rem", background: S.bg }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <div className="home-credibility-grid grid-3col" style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "0", borderTop: `1px solid ${S.border}`, borderLeft: `1px solid ${S.border}` }}>
            {[
      ...
      <section className="home-who" style={{ padding: "6rem 2rem", background: S.bg2, borderTop: `1px solid ${S.border}` }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          ...
          <div className="home-who-grid grid-2col" style={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: "1px", background: S.border }}>
            {[
      ...
      <section className="home-pricing" style={{ padding: "6rem 2rem", background: S.bg }}>
        <div className="home-pricing-grid grid-2col" style={{ maxWidth: 1200, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "6rem", alignItems: "center" }}>
          <div>
            <div style={{ fontFamily: S.mono, fontSize: "0.7rem", letterSpacing: "0.15em", textTransform: "uppercase", color: S.accent, marginBottom: "1rem" }}>
              Pricing
            </div>
      ...
      <section className="home-bottom-cta" style={{
        ...
        <div style={{ position: "relative", zIndex: 1 }}>
          ...
          <div className="home-bottom-buttons cta-stack" style={{ display: "flex", gap: "1rem", justifyContent: "center", flexWrap: "wrap" }}>
            <Link href="/intake/1" style={{
