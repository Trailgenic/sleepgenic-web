  ...
  return (
    <>
      <nav className="sg-nav" style={{
        ...
        <div className="sg-nav-inner" style={{ maxWidth: 1200, margin: "0 auto", padding: "0 2rem", display: "flex", alignItems: "center", justifyContent: "space-between", height: 64 }}>
          ...
          <div className="sg-nav-links" style={{ display: "flex", gap: "2.5rem", alignItems: "center" }}>
            <div className="sg-nav-menu" style={{ display: "flex", gap: "2.5rem", alignItems: "center" }}>
            ...
            <Link className="sg-nav-cta" href="/intake/1" style={{
