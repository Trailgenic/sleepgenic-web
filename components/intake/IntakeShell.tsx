...
export default function IntakeShell({
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#080c0f", color: "#e8edf2", paddingTop: 64 }}>
      <div style={{ height: 3, width: "100%", background: "#1e2d3d" }}>
        <div style={{ height: "100%", width, background: "#3b82f6", transition: "width 0.2s ease" }} />
      </div>
      <div style={{ maxWidth: 760, margin: "0 auto", padding: "2rem 1rem 4rem" }}>{children}</div>
      <footer
        style={{
