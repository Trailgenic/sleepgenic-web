...
type OutcomeBothProps = {
  providerNotes?: string;
};

export default function OutcomeBoth({ providerNotes }: OutcomeBothProps) {
  return (
    <Html>
      <Head />
        ...
        <Container style={{ maxWidth: "600px", margin: "0 auto", padding: "0 24px" }}>
          ...
          <Section style={{ padding: "32px 0" }}>
            ...
            <Text style={{ fontFamily: "Arial, sans-serif", fontSize: "15px", color: "#8fa3b3", lineHeight: "1.7", margin: "0 0 20px" }}>
              Your provider has completed your review and assigned a combined treatment plan that includes CBT-I and prescription support.
            </Text>
            {providerNotes ? (
            ...
            <Text style={{ fontFamily: "Arial, sans-serif", fontSize: "14px", color: "#8fa3b3", lineHeight: "1.7", margin: "16px 0" }}>
              Log in to your portal to view your full treatment plan and next steps: sleepgenic.ai/portal
            </Text>
          </Section>
          <EmailFooter />
        </Container>
